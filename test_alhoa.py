...
class top_block(grc_wxgui.top_block_gui):
	...
	def __init__(self):
		...
		self.mac_0=aloha_mac.aloha_mac(10,11,25,16)
		...
		self.gr_file_source_1 = gr.file_source(gr.sizeof_char*1, "/home/electron/project/exp/block_creation/testfile1", True)
		self.gr_file_sink_0 = gr.file_sink(gr.sizeof_char*1, "/home/electron/project/exp/block_creation/testOutput11")
		self.gr_file_sink_1 = gr.file_sink(gr.sizeof_char*1, "/home/electron/project/exp/block_creation/testOutput10")
