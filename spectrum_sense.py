# removing log function _logpwrfft chain

from gnuradio import gr, window
from stream_to_vector_decimator import stream_to_vector_decimator
import math

class _pwrfft_base(gr.hier_block2):
    """
    Create a abs(fft) stream chain, with real or complex input.
    """

    def __init__(self, sample_rate, fft_size, frame_rate, avg_alpha, average, win=None):
        """
        ...
        self.connect(self, self._sd, fft, c2magsq, self._avg, self)
